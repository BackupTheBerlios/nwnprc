...
public class XP1KeyFile
{
        ...
        throws IOException
    {
        ...
        {
            return;
            //JOptionPane.showMessageDialog(null, "Fatal Error - xp1.key missing. Rerun Settings, or patch NWN to current version.", "Error", 0);
            //System.exit(0);
        }
    ...
    public static final String keyname = "xp1.key";
    public File keyfile;
