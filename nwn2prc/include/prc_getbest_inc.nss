...
int GetBestL1Spell(object oTarget, int nSpell)
{
    ...
    if (GetHasSpell(SPELL_RESIST_ENERGY, oTarget) > 0) nBestSpell = SPELL_RESIST_ENERGY;
...
int GetBestL4Spell(object oTarget, int nSpell)
{
    ...
    if (GetHasSpell(SPELL_LESSER_GLOBE_OF_INVULNERABILITY, oTarget) > 0) nBestSpell = SPELL_LESSER_GLOBE_OF_INVULNERABILITY;
    ...
    if (GetHasSpell(SPELL_GREATER_INVISIBILITY, oTarget) > 0) nBestSpell = SPELL_GREATER_INVISIBILITY;
...
int GetBestL5Spell(object oTarget, int nSpell)
{
    ...
    if (GetHasSpell(SPELL_MASS_INFLICT_LIGHT_WOUNDS, oTarget) > 0) nBestSpell = SPELL_MASS_INFLICT_LIGHT_WOUNDS;
    ...
    if (GetHasSpell(SPELL_MASS_CURE_LIGHT_WOUNDS, oTarget) > 0) nBestSpell = SPELL_MASS_CURE_LIGHT_WOUNDS;
