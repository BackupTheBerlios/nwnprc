const int ITEM_PROPERTY_USE_LIMITATION_ABILITY_SCORE      = 113;
const int ITEM_PROPERTY_USE_LIMITATION_SKILL_RANKS        = 114;
const int ITEM_PROPERTY_USE_LIMITATION_SPELL_LEVEL        = 115;
const int ITEM_PROPERTY_USE_LIMITATION_ARCANE_SPELL_LEVEL = 116;
const int ITEM_PROPERTY_USE_LIMITATION_DIVINE_SPELL_LEVEL = 117;
const int ITEM_PROPERTY_USE_LIMITATION_SNEAK_ATTACK       = 109;
...
const int ITEM_PROPERTY_CAST_SPELL_CASTER_LEVEL           = 112;
const int ITEM_PROPERTY_CAST_SPELL_METAMAGIC              = 110;
const int ITEM_PROPERTY_CAST_SPELL_DC                     = 111;
const int ITEM_PROPERTY_PNP_HOLY_AVENGER                  = 119;
