...
{
    return (
            (nSpellID == SPELL_MASS_CURE_LIGHT_WOUNDS) ||
            (nSpellID == SPELL_MASS_CURE_MODERATE_WOUNDS) ||
            (nSpellID == SPELL_MASS_CURE_SERIOUS_WOUNDS) ||
            (nSpellID == SPELL_MASS_CURE_CRITICAL_WOUNDS)
            );
}
...
{
    return (
            (nSpellID == SPELL_MASS_INFLICT_LIGHT_WOUNDS) ||
            (nSpellID == SPELL_MASS_INFLICT_MODERATE_WOUNDS) ||
            (nSpellID == SPELL_MASS_INFLICT_SERIOUS_WOUNDS) ||
            (nSpellID == SPELL_MASS_INFLICT_CRITICAL_WOUNDS)
            );
}
