...
//const int SPELL_ENERGY_IMMUNITY                     = 879;
...
const int SPELL_MASS_CURE_LIGHT                     = 80;
const int SPELL_MASS_CURE_MODERATE                  = 891;
const int SPELL_MASS_CURE_SERIOUS                   = 894;
const int SPELL_MASS_CURE_CRITICAL                  = 897;
...
//const int SPELL_IMPROVED_MAGE_ARMOR                 = 858;
...
//const int SPELL_MIRROR_IMAGE                        = 852;
...
//const int SPELL_PROTECTION_FROM_ARROWS              = 853;
const int SPELL_TOUCH_OF_IDIOCY                     = 1801;
//const int SPELL_DEEP_SLUMBER                        = 855; //= 1803;
...
const int SPELL_MASS_INFLICT_LIGHT                  = 19;
const int SPELL_MASS_INFLICT_MODERATE               = 892;
const int SPELL_MASS_INFLICT_SERIOUS                = 895;
const int SPELL_MASS_INFLICT_CRITICAL               = 898;
