...
//added below to keep compiler from choking
...
void spellsGenericAreaOfEffect(
        ...
        int nTargetType=1, int bHarmful = FALSE,
        ...
        int bPersistentObject=FALSE, int bResistCheck=FALSE, int nSavingThrowType=4,
