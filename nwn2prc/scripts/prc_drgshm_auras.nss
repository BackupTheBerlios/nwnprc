...
{		 
    ...
    if(nAuraSpellId == nSpellId)
    {
		...
		if(nAuraSpellId == 1111) // replace with proper spellId - Damage Reduction
		{
		...
		else if(nAuraSpellId == 1112) // replace with proper spellId - Regeneration
		{
		...
		else if(nAuraSpellId == 1113) // replace with proper spellId - Conversation skill bonuses
		{
		...
		else if(nAuraSpellId == 1114) // replace with proper spellid - senses aura
		{
		...
		else if(nAuraSpellId == 1115) // replace with proper spellId - damage shield
		{
			nAuraBonus *= 2;
		...
		else if(nAuraSpellId == 1116) // replace with proper spellid - damage resist
		{
			nAuraBonus *= 5;
			int nDamageType = GetDragonDamageType(oCaster);
		...
		else if(nAuraSpellId == 1117) // replace with proper spellid - power aura
		{
