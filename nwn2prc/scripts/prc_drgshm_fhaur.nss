...
{		 
	...
	string sMes = "Fast Healing running.";
    if(nAuraSpellId == nSpellId)
    {
        ...
        effect eLink     = ExtraordinaryEffect( EffectLinkEffects(eFastHeal, eDur) );
...
void main()
{
    ...
    {
	    effect eFNF    = ExtraordinaryEffect( EffectVisualEffect(VFX_DUR_SPELL_AURA_OF_VITALITY) );
