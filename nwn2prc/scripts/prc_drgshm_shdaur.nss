...
{		 
	...
	string sMes = "Damage shield running.";
    if(nAuraSpellId == nSpellId)
    {
        ...
        effect eLink     = ExtraordinaryEffect( EffectLinkEffects(eDmgShld, eDur) );
...
void main()
{
    ...
    {
	    effect eFNF    = ExtraordinaryEffect( EffectVisualEffect(VFX_DUR_SPELL_SHIELD) );
