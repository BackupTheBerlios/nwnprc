    ...
    if(nValue == DYNCONV_SETUP_STAGE)
    {
        if(!GetIsStageSetUp(nStage, oPC))
        {
            ...
            else if(nStage == STAGE_SPELL)
            {
                ...
                AddRunescarSpellChoice(SPELL_RESIST_ENERGY  ,           oPC, 1);
                AddRunescarSpellChoice(SPELL_SEE_INVISIBILITY,          oPC, 1);
                AddRunescarSpellChoice(SPELL_TRUE_STRIKE,               oPC, 1);
                AddRunescarSpellChoice(SPELL_BEARS_ENDURANCE,           oPC, 2);
                ...
                AddRunescarSpellChoice(SPELL_PROTECTION_FROM_ENERGY,    oPC, 2);
                ...
                AddRunescarSpellChoice(SPELL_GREATER_INVISIBILITY,      oPC, 4);
