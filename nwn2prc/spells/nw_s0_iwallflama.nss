    ...
    if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, GetAreaOfEffectCreator()))
    {
        ...
        if(!PRCMyResistSpell(GetAreaOfEffectCreator(), oTarget))
        {
            ...
            //nDamage = d6(2) + GetAbilityModifier(ABILITY_CHARISMA, oCreator);  // JLR - OEI 07/19/05 //pkm oei 10.20.06
             nDamage = d6(2);  // Oni5115 12/22/06 - Spell should do 2d6 + caster level, NOT +cha bonus
            ...
            */
            ...
            nDamage += nCasterLvl;  // Oni5115 12/22/06 - Fixes spell only doing 20 total damage...
