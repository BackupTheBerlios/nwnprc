...
namespace HakInstaller
{
	...
	public class InstallForm : InstallFormBase
	{
		...
		public InstallForm()
		{
			...
			if (NWNInfo.ModeNWN1)
				this.radioButtonNWN1Mode.Checked = true;
			else
				this.radioButtonNWN2Mode.Checked = true;

			if (!NWNInfo.IsNWN2Installed)
				this.radioButtonNWN2Mode.Enabled = false;
			if (!NWNInfo.IsInstalled)
				this.radioButtonNWN1Mode.Enabled = false;
		...
		private System.Windows.Forms.RadioButton radioButtonNWN1Mode;
		private System.Windows.Forms.RadioButton radioButtonNWN2Mode;
		...
		private void InitializeComponent()
		{
			...
			this.radioButtonNWN1Mode = new System.Windows.Forms.RadioButton();
			this.radioButtonNWN2Mode = new System.Windows.Forms.RadioButton();
			...
			// radioButtonNWN1Mode
			// 
			this.radioButtonNWN1Mode.Location = new System.Drawing.Point(48, 16);
			this.radioButtonNWN1Mode.Name = "radioButtonNWN1Mode";
			this.radioButtonNWN1Mode.Size = new System.Drawing.Size(56, 16);
			this.radioButtonNWN1Mode.TabIndex = 8;
			this.radioButtonNWN1Mode.Text = "NWN1";
			this.radioButtonNWN1Mode.CheckedChanged += new System.EventHandler(this.radioButtonNWN1Mode_CheckedChanged);
			// 
			// radioButtonNWN2Mode
			// 
			this.radioButtonNWN2Mode.Location = new System.Drawing.Point(144, 16);
			this.radioButtonNWN2Mode.Name = "radioButtonNWN2Mode";
			this.radioButtonNWN2Mode.Size = new System.Drawing.Size(56, 16);
			this.radioButtonNWN2Mode.TabIndex = 9;
			this.radioButtonNWN2Mode.Text = "NWN2";
			this.radioButtonNWN2Mode.CheckedChanged += new System.EventHandler(this.radioButtonNWN2Mode_CheckedChanged);
			// 
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.radioButtonNWN2Mode);
			this.groupBox1.Controls.Add(this.radioButtonNWN1Mode);
			this.groupBox1.Location = new System.Drawing.Point(288, 264);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(248, 40);
			this.groupBox1.TabIndex = 10;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "NWN1 or NWN2 Updates?";
			// 
			// InstallForm
			// 
