	...
	public class MainForm
	{
		...
		static void Main(string[] args) 
		{
			try
			{
				...
				if (!installPathGiven && !NWNInfo.IsInstalled && !NWNInfo.IsNWN2Installed)
					Terminate("Neverwinter Nights 1 or 2 is not installed");

				// Turn on NWN2 mode on
				if (NWNInfo.IsNWN2Installed && !NWNInfo.IsInstalled)
