...
// Damage Types
int    DAMAGE_TYPE_ALL          = 0;	// 3.5 Damage Reduction
...
effect EffectParalyze(int nSaveDC=-1, int nSave=SAVING_THROW_WILL);
...
effect EffectSetScale( float fScale );
...
// - fIntervalSeconds: length of interval in seconds
// - nDamageType: DAMAGE_TYPE_*
effect EffectDamageOverTime(int nAmount, float fIntervalSeconds, int nDamageType=DAMAGE_TYPE_MAGICAL);
...
///////////////////////////////////////////////////////////////////////////////
int FeatAdd( object oCreature, int iFeatId, int bCheckRequirements );
