...
float	GetFloatParam(string sString, int nPos);
int		GetIntParam(string sString, int nPos);
string	GetStringParam(string sString, int nPos);
...
string GetStringParam(string sString, int nPos)
{
	return (GetTokenByPosition(sString, ",", nPos));
}
...
int GetIntParam(string sString, int nPos)
{
	return (StringToInt(GetTokenByPosition(sString, ",", nPos)));
}
...
float GetFloatParam(string sString, int nPos)
{
	return (StringToFloat(GetTokenByPosition(sString, ",", nPos)));
}
