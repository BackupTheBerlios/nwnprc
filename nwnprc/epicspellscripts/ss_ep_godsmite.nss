...
void main()
{
    ...
    if (GetCanCastSpell(OBJECT_SELF, GODSMIT_DC, GODSMIT_S, GODSMIT_XP))
    {
        ...
        if (BACKLASH_DAMAGE == TRUE)
        {
            ...
            DelayCommand(3.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, eCast, OBJECT_SELF));
            DelayCommand(3.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, eDam, OBJECT_SELF));
        }
        ...
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BIGBYS_INTERPOSING_HAND), oTarget, 0.75);
        DelayCommand(0.75, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BIGBYS_GRASPING_HAND), oTarget, 1.0));
        DelayCommand(1.75, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BIGBYS_CLENCHED_FIST), oTarget, 0.75));
        DelayCommand(2.5, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BIGBYS_CRUSHING_HAND), oTarget, 1.0));
