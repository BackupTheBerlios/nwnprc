...
void SetDefaultFileEnds()
{
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_aber", 335);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_antipl", 708);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_arclb", 375);
    SetPRCSwitch("PRC_FILE_END_cls_feat_arctrk", 100);
    SetPRCSwitch("PRC_FILE_END_cls_feat_arti", 418);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_barb", 453);
    SetPRCSwitch("PRC_FILE_END_cls_feat_bard", 1000);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_blkgrd", 355);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_brage", 181);
    SetPRCSwitch("PRC_FILE_END_cls_feat_brawl", 598);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_chaban", 349);
    SetPRCSwitch("PRC_FILE_END_cls_feat_cheat", 37);
    SetPRCSwitch("PRC_FILE_END_cls_feat_cler", 789);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_corup", 497);
    SetPRCSwitch("PRC_FILE_END_cls_feat_crea", 395);
    SetPRCSwitch("PRC_FILE_END_cls_feat_crusdr", 374);
    SetPRCSwitch("PRC_FILE_END_cls_feat_cwsm", 640);
    SetPRCSwitch("PRC_FILE_END_cls_feat_dalqur", 184);
    SetPRCSwitch("PRC_FILE_END_cls_feat_deepst", 12);
    SetPRCSwitch("PRC_FILE_END_cls_feat_dfa", 348);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_drag", 393);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drgnht", 79);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drgshm", 405);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drnkn", 18);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drowj", 43);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drslyr", 223);
    SetPRCSwitch("PRC_FILE_END_cls_feat_druid", 776);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duel", 66);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duskbl", 735);
    SetPRCSwitch("PRC_FILE_END_cls_feat_dwdef", 201);
    SetPRCSwitch("PRC_FILE_END_cls_feat_eldkni", 288);
    SetPRCSwitch("PRC_FILE_END_cls_feat_enlfis", 168);
    SetPRCSwitch("PRC_FILE_END_cls_feat_eog", 16);
    SetPRCSwitch("PRC_FILE_END_cls_feat_favsol", 1609);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fey", 41);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fh", 34);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fight", 631);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fistra", 345);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_gian", 394);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_healer", 769);
    SetPRCSwitch("PRC_FILE_END_cls_feat_heartw", 108);
    SetPRCSwitch("PRC_FILE_END_cls_feat_hexbl", 570);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_hosp", 303);
    SetPRCSwitch("PRC_FILE_END_cls_feat_hotwm", 17);
    SetPRCSwitch("PRC_FILE_END_cls_feat_iaij", 203);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_knight", 303);
    SetPRCSwitch("PRC_FILE_END_cls_feat_kord", 3);
    SetPRCSwitch("PRC_FILE_END_cls_feat_kotmc", 250);
    SetPRCSwitch("PRC_FILE_END_cls_feat_lasher", 354);
    SetPRCSwitch("PRC_FILE_END_cls_feat_lgdr", 215);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_marsh", 475);
    SetPRCSwitch("PRC_FILE_END_cls_feat_meph", 22);
    SetPRCSwitch("PRC_FILE_END_cls_feat_mharp", 162);
    SetPRCSwitch("PRC_FILE_END_cls_feat_minstr", 45);
    SetPRCSwitch("PRC_FILE_END_cls_feat_monk", 403);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_ninjca", 357);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_outs", 2112);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pal", 500);
    SetPRCSwitch("PRC_FILE_END_cls_feat_palema", 83);
    SetPRCSwitch("PRC_FILE_END_cls_feat_parch", 21);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pdk", 13);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pnpsfr", 140);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psion", 949);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psych", 213);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psywar", 657);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pyro", 280);
    SetPRCSwitch("PRC_FILE_END_cls_feat_rang", 410);
    SetPRCSwitch("PRC_FILE_END_cls_feat_rava", 211);
    SetPRCSwitch("PRC_FILE_END_cls_feat_redav", 143);
    SetPRCSwitch("PRC_FILE_END_cls_feat_redwiz", 195);
    SetPRCSwitch("PRC_FILE_END_cls_feat_rog", 371);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_samur", 664);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_sbheir", 204);
    SetPRCSwitch("PRC_FILE_END_cls_feat_schord", 990);
    SetPRCSwitch("PRC_FILE_END_cls_feat_scout", 500);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_shaman", 919);
    SetPRCSwitch("PRC_FILE_END_cls_feat_shiftr", 100);
    SetPRCSwitch("PRC_FILE_END_cls_feat_shou", 61);
    SetPRCSwitch("PRC_FILE_END_cls_feat_shugen", 552);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_sohei", 627);
    SetPRCSwitch("PRC_FILE_END_cls_feat_sol", 330);
    SetPRCSwitch("PRC_FILE_END_cls_feat_sorc", 2601);
    SetPRCSwitch("PRC_FILE_END_cls_feat_soulkn", 747);
    SetPRCSwitch("PRC_FILE_END_cls_feat_spellf", 14);
    SetPRCSwitch("PRC_FILE_END_cls_feat_spells", 482);
    SetPRCSwitch("PRC_FILE_END_cls_feat_storml", 105);
    SetPRCSwitch("PRC_FILE_END_cls_feat_suel", 469);
    SetPRCSwitch("PRC_FILE_END_cls_feat_swash", 560);
    SetPRCSwitch("PRC_FILE_END_cls_feat_swdsge", 453);
    SetPRCSwitch("PRC_FILE_END_cls_feat_swftwg", 29);
    SetPRCSwitch("PRC_FILE_END_cls_feat_taltia", 18);
    SetPRCSwitch("PRC_FILE_END_cls_feat_tempst", 146);
    SetPRCSwitch("PRC_FILE_END_cls_feat_tempus", 84);
    SetPRCSwitch("PRC_FILE_END_cls_feat_tfshad", 101);
    SetPRCSwitch("PRC_FILE_END_cls_feat_thaykt", 118);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_true", 418);
    SetPRCSwitch("PRC_FILE_END_cls_feat_urang", 530);
    SetPRCSwitch("PRC_FILE_END_cls_feat_vassal", 396);
    SetPRCSwitch("PRC_FILE_END_cls_feat_vigil", 163);
    SetPRCSwitch("PRC_FILE_END_cls_feat_virt", 124);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warbld", 421);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warchf", 114);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wardark", 20);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warlok", 498);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warmnd", 377);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warpr", 69);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wilder", 958);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wiz", 785);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wm", 181);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wrmage", 1188);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_skill_adst", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_alag", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_alienist", 26);
    SetPRCSwitch("PRC_FILE_END_cls_skill_antipl", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_aots", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_arch", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_archer", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_arclb", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_arctrk", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_arti", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_asasin", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_baal", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_barb", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_bard", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_bereft", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_bfz", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_blades", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_blarch", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_blkgrd", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_blmagu", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_bltl", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_bonded", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_brage", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_brawl", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_brimst", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_cbtmed", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_cereb", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_chaban", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_cler", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_cntmp", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_coc", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_corup", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_crea", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_crusdr", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dalqur", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_deepst", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dfa", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_diabol", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_diadra", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dirge", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_disp", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_divcha", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_doa", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dradev", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dradis", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drgnht", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drgshm", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drkwar", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drnkn", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drowj", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_drslyr", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dru", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_duel", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_duskbl", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_dwdef", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_eldkni", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_enlfis", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_eog", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_favsol", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_fh", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_fight", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_fistra", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_fom", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_foz", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_frebzk", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_gfkill", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_harper", 24);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hath", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_havocm", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_healer", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_heartw", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hexbl", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hextor", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hiero", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hmage", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hnshn", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hosp", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_hotwm", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_iaij", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_inidra", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_irnmnd", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_kchal", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_kensei", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_knight", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_kord", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_kotmc", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_lasher", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_lgdr", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_maestr", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_magek", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_manat", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_marsh", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_meph", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_mharp", 30);
    SetPRCSwitch("PRC_FILE_END_cls_skill_minstr", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_monk", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_mos", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_mstalc", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_mystic", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_nights", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ninja", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ninjca", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ocular", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ollam", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ootbi", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_ooze", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_orcus", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_orcwar", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_pal", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_palema", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_parch", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_pdk", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_psion", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_psych", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_psywar", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_pyro", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_rang", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_rava", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_redav", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_redwiz", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_rog", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_rune", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_runec", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sacfis", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_samur", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_savant", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sbheir", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_schord", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_scout", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sdmind", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shadep", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shadow", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shaman", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shiftr", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shou", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_shugen", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sklcln", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sleat", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sncmnd", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sod", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sohei", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sol", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_sorc", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_soulkn", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_spellf", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_spells", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_storml", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_suel", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_swash", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_swdsge", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_swftwg", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_taltia", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_tempst", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_tempus", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_tfshad", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_thaykt", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_thrall", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_tnecro", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_tog", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_true", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_urang", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_vassal", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_vigil", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_virt", 32);
    SetPRCSwitch("PRC_FILE_END_cls_skill_warbld", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_warchf", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_warlok", 33);
    SetPRCSwitch("PRC_FILE_END_cls_skill_warmnd", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_warpr", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_waygde", 29);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wilder", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wiz", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wm", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wrmage", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wrslng", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wwoc", 31);
    SetPRCSwitch("PRC_FILE_END_cls_skill_wwolf", 31);
    ...
    SetPRCSwitch("PRC_FILE_END_iprp_spells", 1380);
    ...
    SetPRCSwitch("PRC_FILE_END_skills", 34);
