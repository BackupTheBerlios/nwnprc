...
const string ALLOW_CLASS_DIVINE_ELEMENTALIST    = "";
const string ALLOW_CLASS_MYSTICAL_SAGE          = "";
const string ALLOW_CLASS_MASTER_SUMMONER        = "";
...
const int CLASS_TYPE_DIVINE_ELEMENTALIST        = 250;
const int CLASS_TYPE_MYSTICAL_SAGE              = 251;
const int CLASS_TYPE_MASTER_SUMMONER            = 252;
...
// Iaijutsu Master
const int FEAT_EPIC_IAIJUTSU_FOCUS = 2315; 
const int FEAT_STRIKE_VOID         = 2316; 
const int FEAT_TWO_CUTS            = 2317; 
const int FEAT_ECHOS_EDGE_1        = 2318; 
const int FEAT_ECHOS_EDGE_2        = 2319; 
const int FEAT_ECHOS_EDGE_3        = 2320; 
const int FEAT_ECHOS_EDGE_4        = 2321; 
const int FEAT_ECHOS_EDGE_5        = 2322; 
const int FEAT_ECHOS_EDGE_6        = 2323; 
const int FEAT_SPIRIT_STRIKE_1     = 2324; 
const int FEAT_SPIRIT_STRIKE_2     = 2325; 
const int FEAT_SPIRIT_STRIKE_3     = 2326; 
const int FEAT_SPIRIT_STRIKE_4     = 2327; 
const int FEAT_SPIRIT_STRIKE_5     = 2328; 
const int FEAT_SPIRIT_STRIKE_6     = 2329; 
const int FEAT_KATANA_FINESSE      = 2330; 
const int FEAT_IAIJUTSU_ATTACK     = 2331; 
const int FEAT_EPIC_IAIJUTSU       = 2332;

// Legendary Dreadnaught
const int FEAT_UNSTOPPABLE_1         = 2300; 
const int FEAT_UNSTOPPABLE_2         = 2301; 
const int FEAT_UNSTOPPABLE_3         = 2302; 
const int FEAT_UNSTOPPABLE_4         = 2303; 
const int FEAT_UNMOVABLE_1           = 2304; 
const int FEAT_UNMOVABLE_2           = 2305; 
const int FEAT_UNMOVABLE_3           = 2306; 
const int FEAT_UNMOVABLE_4           = 2307; 

// Disciple of Baalzebul
const int FEAT_KING_LIES             = 2308; 
const int FEAT_TONGUE_DEVIL          = 2309; 
const int FEAT_SUGGESTION            = 2310; 
const int FEAT_SUMMON_OSYLUTH        = 2311; 
const int FEAT_INSECT_PLAGUE         = 2312; 
const int FEAT_SUMMON_CORNUGON       = 2313; 
const int FEAT_BEGUILEING_NATURE     = 2314; 
...
// Hathran
const int FEAT_COHORT               = 2571; 
const int FEAT_HATH_COMMAND         = 2572; 
const int FEAT_HATH_FEAR1           = 2575; 
const int FEAT_HATH_FEAR2           = 2576; 
const int FEAT_HATH_FEAR3           = 2577; 

// Vigilant
const int FEAT_VIGIL_ARMOR          = 2570; 
const int FEAT_SPRINT               = 2573; 
const int FEAT_VIGIL_HEAL           = 2574; 

//Prerequisitie feats (Hathran and Vigilant)
const int FEAT_ETHRAN               = 2567; 
const int FEAT_ENDURANCE            = 2568; 
const int FEAT_TRACK                = 2569; 
...
const int SPELL_MINSTREL_SONG_HEROISM       = 2146;
const int SPELL_MINSTREL_SONG_GR_HEROISM    = 2147;
