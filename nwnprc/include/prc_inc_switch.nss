...
void SetDefaultFileEnds()
{
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_aber", 252);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_antipl", 621);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_arclb", 293);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_barb", 368);
    SetPRCSwitch("PRC_FILE_END_cls_feat_bard", 889);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_brawl", 511);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_cler", 707);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_corup", 412);
    SetPRCSwitch("PRC_FILE_END_cls_feat_crea", 311);
    SetPRCSwitch("PRC_FILE_END_cls_feat_cwsm", 551);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_drag", 309);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drgnht", 79);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drgshm", 320);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_druid", 694);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duel", 66);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duskbl", 650);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_favsol", 1477);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fey", 41);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fh", 34);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fight", 545);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_gian", 310);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_healer", 686);
    SetPRCSwitch("PRC_FILE_END_cls_feat_heartw", 108);
    SetPRCSwitch("PRC_FILE_END_cls_feat_hexbl", 488);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_knight", 221);
    SetPRCSwitch("PRC_FILE_END_cls_feat_kord", 3);
    SetPRCSwitch("PRC_FILE_END_cls_feat_kotmc", 247);
    SetPRCSwitch("PRC_FILE_END_cls_feat_lasher", 272);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_marsh", 385);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_monk", 321);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_ninjca", 275);
    SetPRCSwitch("PRC_FILE_END_cls_feat_ocu", 643);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_outs", 2028);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pal", 414);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_psion", 864);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psych", 213);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psywar", 573);
    SetPRCSwitch("PRC_FILE_END_cls_feat_rang", 327);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_rog", 289);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_samur", 575);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_scout", 415);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_shugen", 470);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_sohei", 541);
    SetPRCSwitch("PRC_FILE_END_cls_feat_sol", 327);
    SetPRCSwitch("PRC_FILE_END_cls_feat_sorc", 2448);
    SetPRCSwitch("PRC_FILE_END_cls_feat_soulkn", 662);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_suel", 449);
    SetPRCSwitch("PRC_FILE_END_cls_feat_swash", 473);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_true", 336);
    SetPRCSwitch("PRC_FILE_END_cls_feat_urang", 444);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_wilder", 873);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wiz", 703);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wm", 177);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wrmage", 1106);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_pres_dalqur", 5);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spcr_bard", 145);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spcr_ocu", 157);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spcr_sorc", 380);
    SetPRCSwitch("PRC_FILE_END_cls_spcr_suel", 103);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spell_bard", 602);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spell_sorc", 2112);
    SetPRCSwitch("PRC_FILE_END_cls_spell_suel", 493);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spell_wrmage", 418);
    ...
    SetPRCSwitch("PRC_FILE_END_iprp_feats", 17300);
