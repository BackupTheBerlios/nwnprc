...
const int RACIAL_TYPE_DS_DWARF             = 33;
const int RACIAL_TYPE_DS_ELF               = 34;
const int RACIAL_TYPE_DS_HALFELF           = 35;
const int RACIAL_TYPE_DS_HALFGIANT         = 36;
const int RACIAL_TYPE_DS_HALFLING          = 37;
const int RACIAL_TYPE_MUL                  = 38;
const int RACIAL_TYPE_PTERRAN              = 39;
const int RACIAL_TYPE_THRIKREEN            = 40;

//Dragonlance Races
const int RACIAL_TYPE_BAAZ                 = 41;
const int RACIAL_TYPE_BOZAK                = 42;
const int RACIAL_TYPE_DARK_DWARF           = 47;
const int RACIAL_TYPE_GULLY_DWARF          = 48;
const int RACIAL_TYPE_IRDA                 = 54;
const int RACIAL_TYPE_KAGONESTI_ELF        = 44;
const int RACIAL_TYPE_KAPAK                = 43;
const int RACIAL_TYPE_KENDER               = 49;
const int RACIAL_TYPE_KRYNN_HOGRE          = 55;
const int RACIAL_TYPE_KRYNN_MINOTAUR       = 56;
const int RACIAL_TYPE_SILVANESTI_ELF       = 45;
...
const int RACIAL_TYPE_VANARA               = 244;
...
const int RACIAL_TYPE_HAGSPAWN             = 57;
