...
const int SPELL_DEATH_BY_THORNS                     = 2503;
const int SPELL_EVIL_WEATHER                        = 2504;
const int SPELL_FANGS_OF_THE_VAMPIRE                = 2505;
const int SPELL_LAHMS_FINGER_DARTS                  = 2506;
const int SPELL_POWER_LEECH                         = 2507;
const int SPELL_RAPTURE_OF_RUPTURE                  = 2508;
const int SPELL_RED_FESTER                          = 2509;
const int SPELL_ROTTING_CURSE_OF_URFESTRA           = 2510;
const int SPELL_SEETHING_EYEBANE                    = 2511;
const int SPELL_TOUCH_OF_JUIBLEX                    = 2512;
const int SPELL_AYAILLAS_RADIANT_BURST              = 2513;
const int SPELL_BRILLIANT_EMANATION                 = 2514;
const int SPELL_DIVINE_INSPIRATION                  = 2515;
const int SPELL_DIAMOND_SPRAY                       = 2516;
const int SPELL_DRAGON_CLOUD                        = 2517;
const int SPELL_EXALTED_FURY                        = 2518;
const int SPELL_HAMMER_OF_RIGHTEOUSNESS             = 2519;
const int SPELL_PHIERANS_RESOLVE                    = 2520;
const int SPELL_PHOENIX_FIRE                        = 2521;
const int SPELL_RAIN_OF_EMBERS                      = 2522;
const int SPELL_SICKEN_EVIL                         = 2523;
const int SPELL_STORM_OF_SHARDS                     = 2524;
const int SPELL_SUNMANTLE                           = 2525;
const int SPELL_TWILIGHT_LUCK                       = 2526;
