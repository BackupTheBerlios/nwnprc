...
const int SPELL_APOCALYPSE_FROM_THE_SKY             = 2504;
const int SPELL_APOCALYPSE_FROM_THE_SKY_FIRE        = 2505;
const int SPELL_APOCALYPSE_FROM_THE_SKY_ACID        = 2506;
...
const int SPELL_CLAWS_OF_THE_BEBILITH               = 2514;
const int SPELL_CLAWS_OF_THE_SAVAGE                 = 2515;
const int SPELL_CLOUD_OF_THE_ACHAIERAI              = 2516;
const int SPELL_CLUTCH_OF_ORCUS                     = 2517;
const int SPELL_CRUSHING_FIST_OF_SPITE              = 2518;
const int SPELL_CURSE_OF_THE_PUTRID_HUSK            = 2519;
const int SPELL_DAMNING_DARKNESS                    = 2520;
const int SPELL_DEATH_BY_THORNS                     = 2521;
const int SPELL_DEMONCALL                           = 2522;
const int SPELL_DEMONFLESH                          = 2523;
const int SPELL_DESPOIL                             = 2524;
const int SPELL_DEVILS_EGO                          = 2525;
const int SPELL_DEVILS_EYE                          = 2526;
const int SPELL_DEVILS_TAIL                         = 2527;
const int SPELL_DREAD_WORD                          = 2528;
const int SPELL_DRUG_RESISTANCE                     = 2529;
const int SPELL_ECTOPLASMIC_ENCHANCEMENT            = 2530;
const int SPELL_ENTICE_GIFT                         = 2531;
const int SPELL_ETERNITY_OF_TORTURE                 = 2532;
const int SPELL_EVIL_EYE                            = 2533;
const int SPELL_EYE_OF_THE_BEHOLDER                 = 2534;
const int SPELL_EVIL_WEATHER                        = 2535;
const int SPELL_EVIL_WEATHER_RAIN_OF_BLOOD          = 2536;
const int SPELL_EVIL_WEATHER_VIOLET_RAIN            = 2537;
const int SPELL_EVIL_WEATHER_GREEN_FOG              = 2538;
const int SPELL_EVIL_WEATHER_RAIN_OF_FISH           = 2539;
const int SPELL_EXTRACT_DRUG                        = 2540;
const int SPELL_FANGS_OF_THE_VAMPIRE_KING           = 2541;
const int SPELL_FIENDISH_CLARITY                    = 2542;
const int SPELL_FLESH_ARMOR                         = 2543;
const int SPELL_FLESH_RIPPER                        = 2544;
const int SPELL_GRIM_REVENGE                        = 2545;
const int SPELL_GUTWRENCH                           = 2546;
const int SPELL_HEARTACHE                           = 2547;
const int SPELL_HEARTCLUTCH                         = 2548;
const int SPELL_HELLFIRE                            = 2549;
const int SPELL_HELLFIRE_STORM                      = 2550;
const int SPELL_HELLS_POWER                         = 2551;
const int SPELL_IMPRISON_SOUL                       = 2552;
const int SPELL_LAHMS_FINGER_DARTS                  = 2553;
const int SPELL_LIQUID_PAIN                         = 2554;
const int SPELL_MASOCHISM                           = 2555;
const int SPELL_MORALITY_UNDONE                     = 2556;
const int SPELL_PSYCHIC_POISON                      = 2557;
const int SPELL_POWER_LEECH                         = 2558;
const int SPELL_RAPTURE_OF_RUPTURE                  = 2559;
const int SPELL_REALITY_BLIND                       = 2560;
const int SPELL_RED_FESTER                          = 2561;
const int SPELL_RESONATING_RESISTANCE               = 2562;
const int SPELL_ROTTING_CURSE_OF_URFESTRA           = 2563;
const int SPELL_VODARE                              = 2564;
const int SPELL_VENGEANCE_HALO                      = 2565;
const int SPELL_SEETHING_EYEBANE                    = 2566;
const int SPELL_SHRIVELING                          = 2567;
const int SPELL_SONG_OF_FESTERING_DEATH             = 2568;
const int SPELL_SORROW                              = 2569;
const int SPELL_VISION_OF_HEAVEN                    = 2570;
const int SPELL_SPORES_OF_THE_VROCK                 = 2571;
const int SPELL_SPREAD_OF_SAVAGERY                  = 2572;
const int SPELL_STEAL_LIFE                          = 2573;
const int SPELL_STUNNING_SCREECH                    = 2574;
const int SPELL_STOP_HEART                          = 2575;
const int SPELL_THOUSAND_NEEDLES                    = 2576;
const int SPELL_TONGUE_OF_BAALZEBUL                 = 2577;
const int SPELL_TOUCH_OF_JUIBLEX                    = 2578;
const int SPELL_UNHEAVENED                          = 2579;
const int SPELL_UNLIVING_WEAPON                     = 2580;
const int SPELL_UTTERDARK                           = 2581;
const int SPELL_WAVE_OF_GRIEF                       = 2582;
const int SPELL_WAVE_OF_PAIN                        = 2583;
const int SPELL_WIRLWIND_OF_TEETH                   = 2584;
const int SPELL_WRACK                               = 2585;
const int SPELL_WRETCHED_BLIGHT                     = 2586;
...
const int SPELL_AYAILLAS_RADIANT_BURST              = 2587;
const int SPELL_BRILLIANT_EMANATION                 = 2588;
const int SPELL_DIVINE_INSPIRATION                  = 2589;
const int SPELL_DIAMOND_SPRAY                       = 2590;
const int SPELL_DRAGON_CLOUD                        = 2591;
const int SPELL_EXALTED_FURY                        = 2592;
const int SPELL_HAMMER_OF_RIGHTEOUSNESS             = 2593;
const int SPELL_PHIERANS_RESOLVE                    = 2594;
const int SPELL_PHOENIX_FIRE                        = 2595;
const int SPELL_RAIN_OF_EMBERS                      = 2596;
const int SPELL_SICKEN_EVIL                         = 2597;
const int SPELL_STORM_OF_SHARDS                     = 2598;
const int SPELL_SUNMANTLE                           = 2599;
const int SPELL_TWILIGHT_LUCK                       = 2600;
const int SPELL_AMBER_SARCOPHAGUS                   = 2613;
const int SPELL_BASTION_OF_GOOD                     = 2614;
const int SPELL_BLESSED_SIGHT                       = 2615;
const int SPELL_BLINDING_GLORY                      = 2616;
const int SPELL_BOLT_OF_GLORY                       = 2617;
const int SPELL_CALL_FAITHFUL_SERVANTS              = 2618;
const int SPELL_CELESTIAL_BLOOD                     = 2619;
const int SPELL_CELESTIAL_BRILLIANCE                = 2620;
const int SPELL_CHAAVS_LAUGH                        = 2621;
const int SPELL_CONVERT_WAND                        = 2622;
const int SPELL_DANCING_WEB                         = 2623;
const int SPELL_DIVINE_SACRIFICE                    = 2624;
const int SPELL_EASE_PAIN                           = 2625;
const int SPELL_ELATION                             = 2626;
const int SPELL_EMERALD_BURST                       = 2627;
const int SPELL_ENERGIZE_POTION                     = 2628;
const int SPELL_ESTANNAS_STEW                       = 2629;
const int SPELL_EYES_OF_THE_AVORAL                  = 2630;
const int SPELL_HEALING_TOUCH                       = 2631;
const int SPELL_INSPIRED_AIM                        = 2632;
const int SPELL_LANTERN_LIGHT                       = 2633;
const int SPELL_LAST_JUDGEMENT                      = 2634;
const int SPELL_LUMINOUS_ARMOR                      = 2635;
const int SPELL_GREATER_LUMINOUS_ARMOR              = 2636;
const int SPELL_RAIN_OF_BLACK_TULIPS                = 2637;
const int SPELL_RAIN_OF_ROSES                       = 2638;
const int SPELL_RAY_OF_HOPE                         = 2639;
const int SPELL_REMOVE_ADDICTION                    = 2640;
const int SPELL_RIGHTEOUS_SMITE                     = 2641;
const int SPELL_SPREAD_OF_CONTENTMENT               = 2642;
const int SPELL_STARMANTLE                          = 2643;
