...
void main()
{
	...
	nBlastLvl = max(max(GetLocalInt(oPC, "EssenceLevel"), 1), nBlastLvl);
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        PerformAttack(oTarget, oPC, eVis, 0.0, 0, 0, nWpnDmgType, "*Hideous Blow Hit*", "*Hideous Blow Miss*", FALSE, oWeapon);
