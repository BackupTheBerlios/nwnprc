...
int TotalPCPowers(object oPC = OBJECT_SELF)
{
  ...
  iPower =      GetHasFeat(FEAT_NOMAD_BALE_TELEPORT, oPC) + GetHasFeat(FEAT_TELEPATH_CRISIS_OF_LIFE, oPC) + 
		...
		GetHasFeat(FEAT_ALL_DARKVISION, oPC) + GetHasFeat(FEAT_PSIONWILD_DAZE, oPC) + 
		GetHasFeat(FEAT_PSIONWILD_DECELERATION, oPC) + GetHasFeat(FEAT_PSIONWILD_DISINTEGRATE, oPC) + 
		...
		GetHasFeat(FEAT_ALL_ENERGYADAPTSPEC, oPC) + GetHasFeat(FEAT_PSIONWILD_CRYSTALSWARM, oPC) +
		GetHasFeat(FEAT_ALL_THOUGHTSHIELD, oPC) + GetHasFeat(FEAT_ALL_SYNESTHETE, oPC);
