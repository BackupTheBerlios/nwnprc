...
void main()
{
    ...
    FloatingTextStringOnCreature(GetStringByStrRef(16826542) + " " + (GetLocalInt(oPC, "PsiMetaTwin") ? GetStringByStrRef(63798/*Activated*/):GetStringByStrRef(63799/*Deactivated*/)), oPC, FALSE);
}