/*
   ...
   If you have a weapon equipped, you can use this power to produce a horrible poison that coats your weapon.
...
// End of Spell Cast Hook
	...
	{
	    	FloatingTextStringOnCreature("You do not have a valid target for Truevenom Weapon", oCaster, FALSE);
	    	return;
    	}
