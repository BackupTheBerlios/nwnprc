/*
   ...
   Your weapon gains vampiric regen equal to half your caster class.
*/
...
// End of Spell Cast Hook
    ...
    {
    	FloatingTextStringOnCreature("You do not have a valid target for Vampiric Blade", oCaster, FALSE);
    	return;
    }
    int nAugCost = 0;
