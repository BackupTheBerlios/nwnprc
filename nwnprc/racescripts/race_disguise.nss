...
const string sOriginalAppearance = "#TFORIGAPP";  //label for tracking rakshasa's original appearance
...
void main()
{
    ...
    //don't let ninjamastah use disguise if they are polymorphed
