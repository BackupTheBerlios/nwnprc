...
//:://////////////////////////////////////////////
/*
    Gather Horde - Summons an fighter of proper level as a henchmen.
*/
//:://////////////////////////////////////////////
//:: Created By: Oni5115
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if(GetNumHenchmen(oPC) < iMaxHenchmen)
    {
         ...
         if      (iHD > 39)	sSummon = "ow_sum_fght_13";
         else if (iHD > 36)	sSummon = "ow_sum_fght_12";
         else if (iHD > 33)	sSummon = "ow_sum_fght_11";
         else if (iHD > 30)	sSummon = "ow_sum_fght_10";
         else if (iHD > 27)	sSummon = "ow_sum_fght_9";
         else if (iHD > 24)	sSummon = "ow_sum_fght_8";
         else if (iHD > 21)	sSummon = "ow_sum_fght_7";
         else if (iHD > 18)	sSummon = "ow_sum_fght_6";
         else if (iHD > 15)	sSummon = "ow_sum_fght_5";
         else if (iHD > 12)	sSummon = "ow_sum_fght_4";
         else if (iHD > 9)	sSummon = "ow_sum_fght_3";
         else if (iHD > 6)	sSummon = "ow_sum_fght_2";
         else if (iHD > 3)	sSummon = "ow_sum_fght_1";
