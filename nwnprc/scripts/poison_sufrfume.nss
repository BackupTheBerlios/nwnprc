...
void main()
{
    ...
    ApplyAbilityDamage(oTarget, ABILITY_STRENGTH,     1, TRUE, DURATION_TYPE_PERMANENT);
    ApplyAbilityDamage(oTarget, ABILITY_DEXTERITY,    1, TRUE, DURATION_TYPE_PERMANENT);
    ApplyAbilityDamage(oTarget, ABILITY_CONSTITUTION, 1, TRUE, DURATION_TYPE_PERMANENT);
    ApplyAbilityDamage(oTarget, ABILITY_INTELLIGENCE, 1, TRUE, DURATION_TYPE_PERMANENT);
    ApplyAbilityDamage(oTarget, ABILITY_WISDOM,       1, TRUE, DURATION_TYPE_PERMANENT);
