...
{
    if (GetHasFeat(FEAT_BONUS_DOMAIN_AIR, oPC))           IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_AIR_DOMAIN        ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_DEATH, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_DEATH_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_DESTRUCTION, oPC))   IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_DESTRUCTION_DOMAIN), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_EVIL, oPC))          IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_EVIL_DOMAIN       ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_GOOD, oPC))          IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_GOOD_DOMAIN       ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_HEALING, oPC))       IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_HEALING_DOMAIN    ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_KNOWLEDGE, oPC))     IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_KNOWLEDGE_DOMAIN  ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_MAGIC, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_MAGIC_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_PROTECTION, oPC))    IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_PROTECTION_DOMAIN ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_STRENGTH, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_STRENGTH_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_TRAVEL, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_TRAVEL_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_TRICKERY, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_TRICKERY_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_DARKNESS, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_DARKNESS_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_PORTAL, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_PORTAL_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_FORCE, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_FORCE_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_TYRANNY, oPC))       IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_TYRANNY_DOMAIN    ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_DOMINATION, oPC))    IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_DOMINATION_DOMAIN ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_SPIDER, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_SPIDER_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_UNDEATH, oPC))       IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_UNDEATH_DOMAIN    ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_TIME, oPC))          IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_TIME_DOMAIN       ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_DWARF, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_DWARF_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_CHARM, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_CHARM_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_ELF, oPC))           IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_ELF_DOMAIN        ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_FAMILY, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_FAMILY_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_FATE, oPC))          IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_FATE_DOMAIN       ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_GNOME, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_GNOME_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_ILLUSION, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_ILLUSION_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_HATRED, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_HATRED_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_HALFLING, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_HALFLING_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_NOBILITY, oPC))      IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_NOBILITY_DOMAIN   ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_OCEAN, oPC))         IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_OCEAN_DOMAIN      ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_ORC, oPC))           IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_ORC_DOMAIN        ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_RENEWAL, oPC))       IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_RENEWAL_DOMAIN    ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_RUNE, oPC))          IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_RUNE_DOMAIN       ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    if (GetHasFeat(FEAT_BONUS_DOMAIN_SPELLS, oPC))        IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_SPELLS_DOMAIN     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
    ...
    if (GetHasFeat(FEAT_BONUS_DOMAIN_BLIGHTBRINGER, oPC)) IPSafeAddItemProperty(oSkin, ItemPropertyBonusFeat(IP_CONST_FEAT_BLIGHTBRINGER     ), 0.0f, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
}
