...
void main()
{
     ...
     { 
     	if((GetSpellId() == SPELL_SECOND_AURA_PRESENCE && nOtherAura == SPELL_DRACONIC_AURA_PRESENCE)
     	   ...
     	   || (GetSpellId() == SPELL_SECOND_AURA_RESISTACID && nOtherAura == SPELL_DRACONIC_AURA_RESISTANCE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_RESISTCOLD && nOtherAura == SPELL_DRACONIC_AURA_RESISTANCE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_RESISTELEC && nOtherAura == SPELL_DRACONIC_AURA_RESISTANCE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_RESISTFIRE && nOtherAura == SPELL_DRACONIC_AURA_RESISTANCE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_MAGICPOWER && nOtherAura == SPELL_DRACONIC_AURA_MAGICPOWER)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_DRACONIC_AURA_ENERGY)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYACID && nOtherAura == SPELL_DRACONIC_AURA_ENERGY)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYCOLD && nOtherAura == SPELL_DRACONIC_AURA_ENERGY)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYELEC && nOtherAura == SPELL_DRACONIC_AURA_ENERGY)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYFIRE && nOtherAura == SPELL_DRACONIC_AURA_ENERGY)
     	   ...
     	   || (GetSpellId() == SPELL_SECOND_AURA_MAGICPOWER && nOtherAura == SPELL_MARSHAL_AURA_MAGICPOWER)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYACID && nOtherAura == SPELL_MARSHAL_AURA_ENERGYACID)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYCOLD && nOtherAura == SPELL_MARSHAL_AURA_ENERGYCOLD)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYELEC && nOtherAura == SPELL_MARSHAL_AURA_ENERGYELEC)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYFIRE && nOtherAura == SPELL_MARSHAL_AURA_ENERGYFIRE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_MARSHAL_AURA_ENERGYACID)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_MARSHAL_AURA_ENERGYCOLD)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_MARSHAL_AURA_ENERGYELEC)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_MARSHAL_AURA_ENERGYFIRE)
     	   ...
     	   || (GetSpellId() == SPELL_SECOND_AURA_MAGICPOWER && nOtherAura == SPELL_BONUS_AURA_MAGICPOWER)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYACID && nOtherAura == SPELL_BONUS_AURA_ENERGYACID)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYCOLD && nOtherAura == SPELL_BONUS_AURA_ENERGYCOLD)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYELEC && nOtherAura == SPELL_BONUS_AURA_ENERGYELEC)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGYFIRE && nOtherAura == SPELL_BONUS_AURA_ENERGYFIRE)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_BONUS_AURA_ENERGYACID)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_BONUS_AURA_ENERGYCOLD)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_BONUS_AURA_ENERGYELEC)
     	   || (GetSpellId() == SPELL_SECOND_AURA_ENERGY && nOtherAura == SPELL_BONUS_AURA_ENERGYFIRE))
