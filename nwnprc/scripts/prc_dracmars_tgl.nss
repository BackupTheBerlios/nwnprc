...
void main()
{
     ...
     { 
     	if((nOtherAura == SPELL_SECOND_AURA_PRESENCE && GetSpellId() == SPELL_MARSHAL_AURA_PRESENCE)
     	   ...
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYACID && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYACID)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYCOLD && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYCOLD)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYELEC && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYELEC)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYFIRE && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYFIRE)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYACID)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYCOLD)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYELEC)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_MARSHAL_AURA_ENERGYFIRE))
