//::///////////////////////////////////////////////
//:: Draconic Aura Toggle - Bonus Auras
//:: prc_dracxtra_tgl.nss
//::///////////////////////////////////////////////
/*
    Toggles draconic auras gained through feats.
*/
//:://////////////////////////////////////////////
//:: Created By: Fox
...
void main()
{
     ...
     { 
     	if((nOtherAura == SPELL_SECOND_AURA_PRESENCE && GetSpellId() == SPELL_BONUS_AURA_PRESENCE)
     	   ...
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYACID && GetSpellId() == SPELL_BONUS_AURA_ENERGYACID)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYCOLD && GetSpellId() == SPELL_BONUS_AURA_ENERGYCOLD)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYELEC && GetSpellId() == SPELL_BONUS_AURA_ENERGYELEC)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGYFIRE && GetSpellId() == SPELL_BONUS_AURA_ENERGYFIRE)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_BONUS_AURA_ENERGYACID)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_BONUS_AURA_ENERGYCOLD)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_BONUS_AURA_ENERGYELEC)
     	   || (nOtherAura == SPELL_SECOND_AURA_ENERGY && GetSpellId() == SPELL_BONUS_AURA_ENERGYFIRE))
