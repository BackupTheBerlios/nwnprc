...
void DeformGaunt(object oPC ,object oSkin)
{
  ...
  if(GetLocalInt(oSkin, "DeformGauntDex") == 2) return;
    ...
    SetCompositeBonus(oSkin, "DeformGauntDex", 2, ITEM_PROPERTY_ABILITY_BONUS,IP_CONST_ABILITY_CON);
    SetCompositeBonus(oSkin, "DeformgGauntCon", 2, ITEM_PROPERTY_DECREASED_ABILITY_SCORE, IP_CONST_ABILITY_DEX);
