//::///////////////////////////////////////////////
//:: Celestial Lightsblood Damage 1
//:: ravage_cllghtbl1
//:://////////////////////////////////////////////
/*
    1 Dex damage
...
void main()
{
	...
	//effect eDam = EffectAbilityDecrease(ABILITY_DEXTERITY, 1 + nExtra);
	effect eVis = GetRavageVFX();
	
	//SPApplyEffectToObject(DURATION_TYPE_PERMANENT, eDam, oTarget, 0.0f, FALSE);
	ApplyAbilityDamage(oTarget, ABILITY_DEXTERITY, 1 + nExtra, DURATION_TYPE_PERMANENT);
