...
void main()
{
	...
	ApplyAbilityDamage(oTarget, ABILITY_WISDOM, d4(1) + nExtra, DURATION_TYPE_PERMANENT);
	ApplyAbilityDamage(oTarget, ABILITY_INTELLIGENCE, d4(1) + nExtra, DURATION_TYPE_PERMANENT);
