...
// End of Spell Cast Hook
    ...
    if (GetLocalInt(OBJECT_SELF,"TEMPO_CIRCCHAOS"))
     SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, RoundsToSeconds(GetLocalInt(OBJECT_SELF,"TEMPO_CIRCCHAOS")),TRUE,-1,CasterLvl);
    else
    ...
    DeleteLocalInt(OBJECT_SELF,"TEMPO_CIRCCHAOS");
}
