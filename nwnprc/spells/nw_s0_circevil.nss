...
// End of Spell Cast Hook
    ...
    if (GetLocalInt(OBJECT_SELF,"TEMPO_CIRCEVIL"))
     SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, RoundsToSeconds(GetLocalInt(OBJECT_SELF,"TEMPO_CIRCEVIL")),TRUE,-1,CasterLvl);
    else
     SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, HoursToSeconds(nDuration),TRUE,-1,CasterLvl);
     
    DeleteLocalInt(OBJECT_SELF,"TEMPO_CIRCEVIL");
}
