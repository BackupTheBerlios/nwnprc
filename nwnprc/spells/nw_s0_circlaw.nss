...
// End of Spell Cast Hook
    ...
    if (GetLocalInt(OBJECT_SELF,"TEMPO_CIRCLAW"))
     SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, RoundsToSeconds(GetLocalInt(OBJECT_SELF,"TEMPO_CIRCLAW")),TRUE,-1,CasterLvl);
    else
     SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, HoursToSeconds(nDuration),TRUE,-1,CasterLvl);
     
    DeleteLocalInt(OBJECT_SELF,"TEMPO_CIRCLAW");
}
