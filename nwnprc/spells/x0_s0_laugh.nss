...
// End of Spell Cast Hook
    ...
    {
        if (!MyPRCResistSpell(OBJECT_SELF, oTarget,nCasterLvl) && !/*Will Save*/ MySavingThrow(SAVING_THROW_WILL, oTarget, ((GetSpellSaveDC() + GetChangesToSaveDC(OBJECT_SELF))-nModifier), SAVING_THROW_TYPE_MIND_SPELLS))
        {
