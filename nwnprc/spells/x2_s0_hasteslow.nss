...
// End of Spell Cast Hook
    ...
    {//1/3 of the time - do slow effect
        ...
        int nDuration1 = PRCGetCasterLevel(OBJECT_SELF);

        //Fire cast spell at event for the specified target
        SignalEvent(oTarget1, EventSpellCastAt(OBJECT_SELF, SPELL_SLOW, FALSE));
        // Apply effects to the currently selected target.
        SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink1, oTarget1, RoundsToSeconds(nDuration1));
        SPApplyEffectToObject(DURATION_TYPE_INSTANT, eVis1, oTarget1);
