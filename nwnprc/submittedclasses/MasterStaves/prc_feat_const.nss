...
const int FEAT_MSDEFLECTASSAULT     = 2193;
const int FEAT_MSPRECISIONSTRIKE    = 2194;
const int FEAT_MSTRICKYFOOTWORK     = 2195;
const int FEAT_MSQUICKWITHTHESTAFF  = 2196;
const int FEAT_MSMASTEROFTHESTAFF   = 2197;
