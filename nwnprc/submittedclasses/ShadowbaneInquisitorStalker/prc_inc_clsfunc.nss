...
////////////////Begin Shadowbane Class Functions/////////
////////////////Begin Merciless Purity//////////////////

void MercilessPurity(object oPC)
{

SendMessageToPC(oPC, "You have killed an corrupt creature");

if(GetHasFeat(FEAT_MERCILESS_PURITY, oPC))
    {
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectSavingThrowIncrease(SAVING_THROW_FORT, 1, SAVING_THROW_TYPE_ALL), oPC, HoursToSeconds(24));
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectSavingThrowIncrease(SAVING_THROW_REFLEX, 1, SAVING_THROW_TYPE_ALL), oPC,HoursToSeconds(24));
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_GOOD_HELP), oPC);
    
    DecrementRemainingFeatUses(oPC, FEAT_MERCILESS_PURITY);
    }
////////////////End Merciless Purity//////////////////
}

///////////////Begin Sacred Stealth1//////////////////////
void SacredStealthLvl1(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 1;
    int nValue = 4;

    if(GetLevelByClass(CLASS_TYPE_SHADOWBANE_INQUISITOR) < 7) nValue += 4;
    if(GetLevelByClass(CLASS_TYPE_SHADOWBANE_STALKER) < 7) nValue += 4;

    effect eHide = EffectSkillIncrease(SKILL_HIDE, nValue);
    effect eMove = EffectSkillIncrease(SKILL_MOVE_SILENTLY, nValue);
...
///////////////Begin Sacred Stealth2//////////////////////
void SacredStealthLvl2(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 2;     
    int nValue = 4;
...
///////////////Begin Sacred Stealth3//////////////////////
void SacredStealthLvl3(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 3;
    int nValue = 4;
...
///////////////Begin Sacred Stealth4//////////////////////
void SacredStealthLvl4(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 4;
    int nValue = 4;
...
///////////////Begin Sacred Stealth5//////////////////////
void SacredStealthLvl5(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 5;
    int nValue = 4;
...
///////////////Begin Sacred Stealth6//////////////////////
void SacredStealthLvl6(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 6;
    int nValue = 4;
...
///////////////Begin Sacred Stealth7//////////////////////
void SacredStealthLvl7(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 7;
    int nValue = 4;
...
///////////////Begin Sacred Stealth8//////////////////////
void SacredStealthLvl8(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 8;
    int nValue = 4;
...
///////////////Begin Sacred Stealth9//////////////////////
void SacredStealthLvl9(object oCaster)
{
    //Declare major variables
    int nCharismaBonus = GetAbilityModifier(ABILITY_CHARISMA, oCaster);
    effect eVis = EffectVisualEffect(VFX_IMP_IMPROVE_ABILITY_SCORE);
    int nDuration = nCharismaBonus + 9;
    int nValue = 4;
