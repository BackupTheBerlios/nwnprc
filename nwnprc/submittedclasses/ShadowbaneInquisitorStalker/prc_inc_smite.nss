...
const int SMITE_TYPE_CORRUPT    = 6;     
       ...
       case SMITE_TYPE_CORRUPT:
        {
            ...
            nDamage = GetLevelByClass(CLASS_TYPE_SHADOWBANE_INQUISITOR, oPC)
                + 1;
            nDamageType = DAMAGE_TYPE_DIVINE;
            sFailedTarget = "Smite Failed: Target";
            sFailedSmiter = "Smite Failed: smiter";    
            sHit =  "Smite Corrupt Hit";
            sMiss = "Smite Corrupt Missed";
