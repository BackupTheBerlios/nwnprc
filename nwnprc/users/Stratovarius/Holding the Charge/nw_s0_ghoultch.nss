...
//Code to run when concentration is lost
void ConcentrationLossCode(object oCaster, object oTarget, int nCasterLevel)
{
    //CODE HERE
...
void main()
{
    ...
    SPSetSchool(SPELL_SCHOOL_NECROMANCY);  //Put Spell School Here
