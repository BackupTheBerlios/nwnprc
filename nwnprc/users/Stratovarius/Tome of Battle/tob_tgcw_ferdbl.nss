...
void main()
{
        ...
        if(move.bCanManeuver)
        {
                if(GetIsSkillSuccessful(oInitiator, SKILL_JUMP, nArmor))
                {
                        ...
                        PerformAttack(oTarget, oInitiator, eNone, 0.0, 0, 0, 0, FALSE, "Feral Death Blow Hit", "Feral Death Blow Miss");
                ...
                else PerformAttack(oTarget, oInitiator, eNone, 0.0, 0, 0, 0, FALSE);
        }
}
