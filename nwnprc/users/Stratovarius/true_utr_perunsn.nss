...
// End of Spell Cast Hook
    ...
    if(utter.bCanUtter)
    {
        ...
        {
       		utter.ipIProp = PRCItemPropertyBonusFeat(IP_CONST_FEAT_BLINDFIGHT);
       		object oSkin = GetPCSkin(oTrueSpeaker);
       		IPSafeAddItemProperty(oSkin, utter.ipIProp, utter.fDur, X2_IP_ADDPROP_POLICY_KEEP_EXISTING, FALSE, FALSE);
       		// Visuals 
