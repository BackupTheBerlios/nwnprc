...
*/ /** @file
    ...
    Normal:  Your ally experiences a tremendous rejuvenation as healing energy soothes her wounds.
             Your ally gains regeneration +15.
    Reverse: Massive rents and tears appear on the body of your foe.
             Your foe takes a 8d6 damage, and 8d6 damage the next round if you concentrate. Concentration involves doing nothing more strenous than moving.
*/
...
// End of Spell Cast Hook
    ...
    if(utter.bCanUtter)
    {
        ...
        if (utter.nSpellId == UTTER_WORD_NURTURING_CRITICAL)
        {
        	...
        	// Impact VFX 
        	utter.eLink2 = EffectVisualEffect(VFX_IMP_HEALING_X_CYA);
        }
        ...
        else // UTTER_WORD_NURTURING_CRITICAL_R
        {
			...
			if(utter.bEmpower) nDamage += (nDamage/2);
        		utter.eLink2 = EffecLinkEffects(EffectVisualEffect(VFX_IMP_MAGCYA), EffectDamage(nDamage));
