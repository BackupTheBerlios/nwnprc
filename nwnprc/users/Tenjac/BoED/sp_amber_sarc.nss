...
void MakeImmune(object oTarget, float fDur)
{
	SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectImmunity(IMMUNITY_TYPE_), oTarget, fDur)
	
	effect eLink    = EffectLinkEffects(eLink, EffectImmunity(IMMUNITY_TYPE_ABILITY_DECREASE));
