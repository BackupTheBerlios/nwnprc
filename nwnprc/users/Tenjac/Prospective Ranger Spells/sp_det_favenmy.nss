...
void main()
{
        ...
        {
                CheckForPresence(RACIAL_TYPE_GOBLINOID, lLoc, "goblinoid", "goblinoids");
        }
        ...
        {
                CheckForPresence(RACIAL_TYPE_MONSTROUS, lLoc, "monster", "monsters");
        }
        ...
        {
                CheckForPresence(RACIAL_TYPE_REPTILIAN, lLoc, "reptilian", "reptilians");
        }
