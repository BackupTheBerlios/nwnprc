...
2daMerge -c -odyncloakoffsets.txt -rreferences.txt -S output\baseitems.2da -M dyncloak\baseitems.2da -O output\baseitems.2da
erf -c prccep2dyncloak.hak output\*.2da
pause