...
/***************************
Primogenitors modification to apply an AoE that can be used instead
***************************/
    //Before applying tilemagic, if you set a local string on the module
    //this string can be used as a script to run on an AoE object around
    //the tilemagic.
    //For example, you might set footsets to splash when in a water AoE.
    //Enter     TilemagicAoEEnter
    //Exit      TilemagicAoEExit
    //Heartbeat TilemagicAoEHB
/***************************
End of modification
***************************/
...
Primogenitors modification to apply an AoE that can be used instead
***************************/
        string sAoEEnter = GetLocalString(GetModule(), "TilemagicAoEEnter");
        string sAoEExit  = GetLocalString(GetModule(), "TilemagicAoEExit");
        string sAoEHB    = GetLocalString(GetModule(), "TilemagicAoEHB");
        if(sAoEEnter != ""
            || sAoEExit != ""
            || sAoEHB != "")
        {
            effect eAoE = EffectAreaOfEffect(215, sAoEEnter, sAoEHB, sAoEExit);
            eTile = EffectLinkEffects(eTile, eAoE);
            eTile = SupernaturalEffect(eTile);
        }
/***************************
End of modification
***************************/
