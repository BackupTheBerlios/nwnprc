...
void main()
{
    ...
    itemproperty ipIP;
    //1d3 damage
    ipIP = ItemPropertyMonsterDamage(IP_CONST_MONSTERDAMAGE_1d3);
    IPSafeAddItemProperty(oBite, ipIP);
    //Filth fever—bite, Fortitude DC 11, incubation period 1d3 days,
    //damage 1d3 Dex and 1d3 Con.
    ipIP = ItemPropertyOnMonsterHitProperties(IP_CONST_ONMONSTERHIT_DISEASE,
        DISEASE_FILTH_FEVER);
}
